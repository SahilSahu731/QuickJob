  ...
  return (
    <>
      ...
      <div className="container px-4 min-h-[65vh] 2xl:px-20 mx-auto my-10">
        ...
        <div className="flex gap-2 mb-6 mt-3 ">{isEdit || userData && userData.resume === ""
        ? <>
            <label className="flex items-center" htmlFor="resume">
              <p className="bg-blue-100 text-blue-600 px-4 py-2 rounded-lg mr-2">{resume ? resume.name : "Upload Resume"}</p>
              <input
              type="file"
              hidden
            ...
            <button onClick={updateResume} className="bg-green-200 border border-green-600 rounded-lg px-4 py-2">Save</button>
        </> 
